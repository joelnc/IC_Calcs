...
##
import os
os.chdir("c:/Users/95218/Python/IC_Calcs")
import pyodbc
...
# conn = pyodbc.connect(
#     "DRIVER={ODBC Driver 17 for SQL Server};SERVER=myrs-gisdev-01;DATABASE=;Trusted_Connection=yes;"
# )

## connect to SDW
conn2 = pyodbc.connect(
    "DRIVER={ODBC Driver 17 for SQL Server};SERVER=virt-sde-01;DATABASE=sdw;Trusted_Connection=yes;"
)

## Set cursor
cursor = conn2.cursor()

## SQL to select these 2 fields from that one table
cursor.execute("SELECT INV_BY,DS_ID FROM STORMCONNECTIVITY_LN")
...
## So how now to poitn clip at the table within the odbc connection?
    
    

sdwPath = "S:/Public/CityGIS/ArcSDE/connections/sde.sde/"
dbCommercial = sdwPath + "dbo.IMPERVIOUSSURFACENSF_PY"
watershedShape = culvDir + "paw_subs_merge.shp"
commercial_clip = "in_memory\\commercial_clip"
arcpy.Clip_analysis(dbCommercial, watershedShape, "in_memory\\commercial_clip")
...
wBasins = "D:/ArcpyOutput/monitDelin/oneOffDelins/coffey_check.shp"
