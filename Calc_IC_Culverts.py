...
wBasins = culvDir + "runSubs/" + "suReSxPaLg.shp" #Sugar Reedy Sixmile Paw Long 
wBasins = culvDir + "runSubs/" + "group2_DAs_v3.shp" # LClarke, Briar, Irwin, LLSug, Mallard, Mcmullen
wBasins = culvDir + "runSubs/" + "group3_DAs_v2.shp" # McAlpine, ULS
